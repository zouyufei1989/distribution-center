alter table d_customer add column create_date date not null;
...
alter table d_customer add column updater varchar(20) not null;
alter table d_customer add column update_ip varchar(20) not null;
