...
public class BannerController extends BaseController {
    ...
    public ResponseEntity<Map<String, Object>> add(@RequestBody Banner banner) {
        Map<String, Object> result = new HashMap<>();
    ...
    public ResponseEntity<Map<String, Object>> edit(@RequestBody Banner banner) {
        Map<String, Object> result = new HashMap<>();
        this.bannerService.edit(banner);
        return new ResponseEntity<>(result, HttpStatus.OK);
    }
