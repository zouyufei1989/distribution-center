                    ...
                    <div class="ibox-content">
                        <form role="form" class="form-inline" style="padding: 0px">
                            ...
                            <div class="param_row">
                                ...
                                <div class="form-group">
                                    <label>方案名称:</label> <input type="text" id="bonusPlan.name" search-param class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>状态:</label>
                                    <status-combo id="bonusPlan.status" search-param must_choose_one="false"></status-combo>
                                </div>
...
<script type="text/javascript">
    loadJS("../script/js/view/bonusPlan/index.js", 1)
    loadJS("../script/js/view/bonusPlan/update.js", 1)
    loadJS("../script/js/view/bonusPlan/detail.js", 1)
</script>
