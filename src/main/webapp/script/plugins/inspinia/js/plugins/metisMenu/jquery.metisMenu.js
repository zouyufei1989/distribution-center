...
!function (a) {
    ...
    function b() {
        var a = document.createElement("mm"), b = {WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "oTransitionEnd otransitionend", transition: "transitionend"};
    ...
    e.TRANSITION_DURATION = 350, e.DEFAULTS = {toggle: !0, doubleTapToGo: !1, activeClass: "active"}, e.prototype.init = function () {
        ...
        if (!this.transitioning && !f.hasClass("in")) {
            g.addClass(c), this.options.toggle && /**this.hide(g.siblings().children("ul.in")), 点及其他菜单，当前菜单不关闭**/ f.removeClass("collapse").addClass("collapsing").height(0), this.transitioning = 1;
            var h = function () {
